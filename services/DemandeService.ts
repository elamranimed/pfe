...
export const DemandeService = {
  ...
  findByUser: async (userId: number) => prisma.demande.findMany({ where: { userid: userId } }),
  findByBureau: async (bureauId: number) => prisma.demande.findMany({ where: { bureauid: bureauId } }),
}
