...
const PIE_COLORS = ['#1a5298', '#e87461'];
      ...
      <div className="space-y-6">
        ...
        {!loading && (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
            <KpiCard
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a5298" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <KpiCard
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e87461" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              accentColor="#1a5298"
              accentBg="rgba(232,116,97,0.1)"
            />
            <KpiCard
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2d6cb4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              accentColor="#1a5298"
              accentBg="rgba(45,108,180,0.1)"
            />
            <KpiCard
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0d2847" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              accentColor="#1a5298"
              accentBg="rgba(13,40,71,0.1)"
            />
            <KpiCard
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c75a4a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="lg:col-span-2 rounded-2xl p-6 bg-card border border-border shadow-sm">
              ...
              <ChartContainer config={barChartConfig} className="h-[280px] w-full">
                <BarChart data={monthlyChartData} barGap={2} barCategoryGap="20%">
                  ...
                  <Bar dataKey="Attendu" fill="var(--color-Attendu)" radius={[4, 4, 0, 0]} opacity={0.7} />
            ...
            <div className="rounded-2xl p-6 flex flex-col bg-card border border-border shadow-sm">
              ...
              <div className="flex items-center justify-center gap-6 mt-2">
                <div className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full" style={{ background: '#1a5298' }} />
